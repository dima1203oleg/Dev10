...
const CPV_KEYWORD_MAP: Array<{ cpv: string; terms: string[] }> = [
  { cpv: "45", terms: ["будівництв", "ремонт", "реконструкці", "покрівл", "утепленн", "асфальт", "дорог", "бруківк", "монтаж", "демонтаж", "споруд", "укритт", "вікн", "двер", "фасад"] },
  { cpv: "30", terms: ["комп'ютер", "ноутбук", "сервер", "принтер", "сканер", "картридж", "оргтехнік", "монітор", "пк"] },
  { cpv: "48", terms: ["програмн", "софт", "пз", "ліцензі", "microsoft", "антивірус"] },
  { cpv: "72", terms: ["it", "розробк", "технічн підтримк", "хостинг", "веб", "сайт", "тестуванн"] },
  { cpv: "33", terms: ["медичн", "лік", "фармацевт", "препарат", "шприц", "бинт", "вакцин", "рентген", "узд", "томограф", "рукавичк"] },
  { cpv: "09", terms: ["бензин", "дизель", "палив", "газ", "нафтопродукт", "дров", "вугілл", "електроенергі", "електричн енергі"] },
  { cpv: "15", terms: ["продукт", "харчуванн", "хліб", "м'яс", "молок", "овоч", "фрукт", "риб", "цукор", "масл", "борошн", "круп"] },
  { cpv: "60", terms: ["перевезенн", "транспорт", "доставк", "логістик", "автобус", "вантаж"] },
  { cpv: "71", terms: ["проектуванн", "авторськ нагляд", "технічн нагляд", "геодезі", "інженерн послуг", "експертиз проект"] },
  { cpv: "90", terms: ["смітт", "відход", "прибиранн", "клінінг", "дезінфекці", "благоустрі", "озелененн"] },
  { cpv: "34", terms: ["автомобіл", "транспортн засоб", "спецтехнік", "екскаватор", "трактор", "запчастин"] },
  { cpv: "39", terms: ["мебл", "стіл", "стільц", "шаф", "посуд", "покритт для підлог"] }
];

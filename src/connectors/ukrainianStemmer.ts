...
const PROCURMENT_SYNONYMS: Record<string, string[]> = {
  "укриття": ["вкриття", "бомбосховище", "сховище", "протирадіаційне", "прсі", "захисна споруда", "найпростіше укриття"],
  "бомбосховище": ["укриття", "сховище", "протирадіаційне", "захисна споруда"],
  "будівництво": ["новому будівництву", "зведення", "спорудження", "будівельні роботи", "будівництва"],
  "ремонт": ["ремонтні роботи", "реконструювання", "капітальний ремонт", "поточний ремонт", "відновлення", "термомодернізація"],
  "ноутбук": ["комп'ютер", "портативний комп'ютер", "лэптоп", "персональний комп'ютер", "пк", "техніка"],
  "школа": ["заклад загальної середньої освіти", "ззсо", "гімназія", "ліцей", "навчальний заклад", "школи", "шкіл"],
  "лікарня": ["заклад охорони здоров'я", "зоз", "кнп", "госпіталь", "амбулаторія", "поліклініка", "медичний зацікавлений"],
  "автомобіль": ["автотранспортний засіб", "транспортний засіб", "авто", "спецавтомобіль", "легковий"],
  "паливо": ["бензин", "дизельне паливо", "дп", "газ", "пально-мастильні", "пмм"],
  "харчування": ["продукти харчування", "харчові продукти", "послуги з харчування", "кетеринг", "годування"],
  "генератор": ["дизель-генератор", "генераторна установка", "джерело живлення", "електрогенератор"],
  "освітлення": ["вуличне освітлення", "світлодіодні", "led", "світильники", "освітлювальне"],
  "дорога": ["автомобільна дорога", "шляхи", "дорожнє покриття", "автодорога", "бруківка", "асфальт"]
};
